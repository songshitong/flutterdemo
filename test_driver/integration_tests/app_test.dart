...
//driver.enterText("") 本次会覆盖上一次的
//长按
//await driver.scroll(exchangeOutputFinder, 0, 0, Duration(seconds: 2));
void main() {
  //编写测试
//
...
//    flutterDriver提供三个滚动方法，scrollUntilVisible用的最多
    test("验证list最后一个", () async {
      ...
      final timeLine = (await flutterDriver?.traceAction(() async {
        ...
        await flutterDriver?.scrollUntilVisible(listFinder, listLastFinder,
            dyScroll: -50);
      }))!;
