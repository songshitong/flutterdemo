      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(shadows: [
                Shadow(
                    ...
                    blurRadius: 2,
                    offset: Offset(
                        5, 5)) //设置阴影 蓝色， blurRadius模糊度，值越大越模糊，offfset阴影的偏移位置
              ]),
            ),
            Text(
              " text " * 14,
            ...
            Text(r'$$',
                semanticsLabel:
                    'Double dollars'), //文本的另一种语义标签,这对于将缩写词或短词替换为全词很有用
            Text('hhhhhhhhhhh China',
                style: TextStyle(
                  ...
                  fontSize: 18.0, //字体大小
                  height:
                      1.2, //该属性用于指定行高，但它并不是一个绝对值，而是一个因子，具体的行高等于fontSize*height,行高，行间距
